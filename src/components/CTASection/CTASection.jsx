  ...
  return (
    <section className={styles.section} style={{ backgroundImage: `url(${ctaBackground})` }}>
      ...
      <div className={styles.content}>
        ...
        <p>At TBS.Studio, we prioritize safety and style in every product we create.
Our furniture is made with non-toxic finishes and sturdy construction to ensure the well-being of your little ones.</p>
        <button
